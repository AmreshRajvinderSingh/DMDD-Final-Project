...
const UpdateSupplier = () => {
  ...
  useEffect(() => {
    ...
    fetchSuppliers();
  }, [suppliers]); // Re-fetch suppliers when suppliers state changes
  ...
  const handleUpdate = async () => {
    try {
      ...
      // Update suppliers state to reflect the changes
      ...
      setSuppliers(updatedSuppliers); // Update suppliers state
      setEditSupplier(null);
...
<td>{editSupplier && editSupplier.SupplierID === supplier.SupplierID ?
